...
export const validatePrimaryDetails = (data,pickup,selectedOutlet, setIsError) => {
  var isValid = true;
...
//       awb===""
//     ) {
//       handleValidationChange("dropoff_awb", true, setIsError);
//       isValid = isValid && false;
//     } else {
//       handleValidationChange("dropoff_awb", false, setIsError);
//       isValid = isValid && true;
//     }
//   } else {
//     handleValidationChange("dropoff_awb", false, setIsError);
